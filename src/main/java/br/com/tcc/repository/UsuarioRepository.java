...
public class UsuarioRepository implements Serializable {
	...
	public Usuario porUsuario(String usuario) {
		try {
			return entityManager.createQuery("from Usuario where usuario = :usuario", Usuario.class)
	 ...
	 * 
	 * try { usuario = this.manager.createQuery(
	 * "from Usuario where lower(email) = :email", Usuario.class)
	 * .setParameter("email", email.toLowerCase()).getSingleResult(); } catch
	 * (NoResultException e) { // nenhum usuário encontrado com o e-mail
	 * informado }
	 * 
	 * return usuario; }
	 */
